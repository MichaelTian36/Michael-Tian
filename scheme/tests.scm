...
(quote (3 (7 apple . (3 . (5 . banana)))))
;expect (3 (7 apple 3 5 . banana))
...
(define x (lambda (a b) (* a 2)))
;expect x

x
;expect (lambda (a b) (* a 2))

(define y (lambda z (+ z 2)))
;expect y
