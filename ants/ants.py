...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if isinstance(self.ant, QueenAnt) and not self.ant.imposter:
                return
            elif self.ant.container and isinstance(self.ant.ant, QueenAnt) and not self.ant.ant.imposter:
                return
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while curr_place != hive:
            if curr_place.bees != []:
                if self.min_range <= rnge and self.max_range >= rnge:
...
# BEGIN Problem 7
class WallAnt(Ant):
    """WallAnt is an ant that does no damage and has four armor."""
    name = 'Wall'
    food_cost = 4
    def __init__(self):
        Ant.__init__(self, 4)
...
class ScubaThrower(ThrowerAnt):
    """ScubaThrower does not die when placed on a water place."""
    name = 'Scuba'
    watersafe = True
    food_cost = 6
    ...
    def action(self, colony):
        ...
        if self.imposter:
            ...
            while behind:
                ...
                if ant:
                    if ant.container:
                        if ant.ant and ant.ant not in self.ants_doubled:
